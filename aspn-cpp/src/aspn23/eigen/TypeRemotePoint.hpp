...
public:
	...
	TypeRemotePoint(
	    ...
	    double position2,
	    double position3,
	    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> position_covariance);
	 ...
	 */
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> get_position_covariance()
	    const;
