...
public:
	...
	TypeMounting(Eigen::Matrix<double, Eigen::Dynamic, 1> lever_arm,
	 ...
	 */
	Eigen::Matrix<double, Eigen::Dynamic, 1> get_lever_arm() const;

	/**
	 * 3x1 lever arm vector describing the sensor position in the platform body frame.
	 */
	void set_lever_arm(Eigen::Matrix<double, Eigen::Dynamic, 1>);

	/**
	 * 3x1 lever arm uncertainty vector as standard deviations in the platform body frame.
	 */
	Eigen::Matrix<double, Eigen::Dynamic, 1> get_lever_arm_sigma() const;

	/**
	 * 3x1 lever arm uncertainty vector as standard deviations in the platform body frame.
	 */
	void set_lever_arm_sigma(Eigen::Matrix<double, Eigen::Dynamic, 1>);
	 ...
	 */
	Eigen::Matrix<double, Eigen::Dynamic, 1> get_orientation_quaternion() const;
	 ...
	 * An array of NaNs indicates this optional field is not provided.
	 */
	void set_orientation_quaternion(Eigen::Matrix<double, Eigen::Dynamic, 1>);
	 ...
	 */
	Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>
	get_orientation_tilt_error_covariance() const;
	 ...
	 * A matrix of NaNs indicates this optional field is not provided.
	 */
	void set_orientation_tilt_error_covariance(
	    Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor>);
