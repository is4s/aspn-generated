...
xt::pytensor<double, 1> MeasurementSpeed::get_error_model_params() const {
	nullptr_check();
...
void MeasurementSpeed::set_error_model_params(xt::pytensor<double, 1> error_model_params) {
	nullptr_check();
