...
xt::pytensor<double, 2> MetadataMagneticField::get_k() const {
	nullptr_check();
...
void MetadataMagneticField::set_k(xt::pytensor<double, 2> k) {
	nullptr_check();
...
xt::pytensor<double, 1> MetadataMagneticField::get_b() const {
	nullptr_check();
...
void MetadataMagneticField::set_b(xt::pytensor<double, 1> b) {
	nullptr_check();
