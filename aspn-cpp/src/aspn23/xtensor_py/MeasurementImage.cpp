...
xt::pytensor<uint8_t, 1> MeasurementImage::get_image_data() const {
	nullptr_check();
...
void MeasurementImage::set_image_data(xt::pytensor<uint8_t, 1> image_data) {
	nullptr_check();
...
xt::pytensor<double, 1> MeasurementImage::get_model_coefficients() const {
	nullptr_check();
...
void MeasurementImage::set_model_coefficients(xt::pytensor<double, 1> model_coefficients) {
	nullptr_check();
