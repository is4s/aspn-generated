...
xt::pytensor<double, 2> MeasurementDeltaPosition::get_covariance() const {
	nullptr_check();
...
void MeasurementDeltaPosition::set_covariance(xt::pytensor<double, 2> covariance) {
	nullptr_check();
...
xt::pytensor<double, 1> MeasurementDeltaPosition::get_error_model_params() const {
	nullptr_check();
...
void MeasurementDeltaPosition::set_error_model_params(xt::pytensor<double, 1> error_model_params) {
	nullptr_check();
