...
#include <aspn23/MeasurementSatnav.h>
 ...
 */
class MeasurementSatnav : public TypeHeader {
public:
	/**
	 ...
	 */
	MeasurementSatnav(Aspn23MeasurementSatnav* c_struct, bool take_ownership = true);

	MeasurementSatnav(TypeHeader header,
	...
	MeasurementSatnav(const MeasurementSatnav& other);
	MeasurementSatnav& operator=(const MeasurementSatnav& rhs);

	MeasurementSatnav(MeasurementSatnav&& other);
	MeasurementSatnav& operator=(MeasurementSatnav&& rhs);
	 ...
	 */
	Aspn23MeasurementSatnav* get_aspn_c() const;
	 ...
	 * is destroyed.
	 */
	void reset_aspn_c(Aspn23MeasurementSatnav* replacement_struct, bool take_ownership = true);
...
private:
	Aspn23MeasurementSatnav* c_struct;
