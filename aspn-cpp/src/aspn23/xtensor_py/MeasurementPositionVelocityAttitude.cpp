...
xt::pytensor<double, 1> MeasurementPositionVelocityAttitude::get_quaternion() const {
	nullptr_check();
...
void MeasurementPositionVelocityAttitude::set_quaternion(xt::pytensor<double, 1> quaternion) {
	nullptr_check();
...
xt::pytensor<double, 2> MeasurementPositionVelocityAttitude::get_covariance() const {
	nullptr_check();
...
void MeasurementPositionVelocityAttitude::set_covariance(xt::pytensor<double, 2> covariance) {
	nullptr_check();
...
xt::pytensor<double, 1> MeasurementPositionVelocityAttitude::get_error_model_params() const {
	nullptr_check();
