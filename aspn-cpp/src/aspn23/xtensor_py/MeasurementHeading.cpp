...
xt::pytensor<double, 1> MeasurementHeading::get_error_model_params() const {
	nullptr_check();
...
void MeasurementHeading::set_error_model_params(xt::pytensor<double, 1> error_model_params) {
	nullptr_check();
