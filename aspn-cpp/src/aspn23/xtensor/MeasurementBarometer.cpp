...
xt::xtensor<double, 1> MeasurementBarometer::get_error_model_params() const {
	nullptr_check();
...
void MeasurementBarometer::set_error_model_params(xt::xtensor<double, 1> error_model_params) {
	nullptr_check();
