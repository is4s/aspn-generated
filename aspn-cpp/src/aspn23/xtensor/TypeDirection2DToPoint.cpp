...
xt::xtensor<double, 1> TypeDirection2DToPoint::get_error_model_params() const {
	nullptr_check();
...
void TypeDirection2DToPoint::set_error_model_params(xt::xtensor<double, 1> error_model_params) {
	nullptr_check();
