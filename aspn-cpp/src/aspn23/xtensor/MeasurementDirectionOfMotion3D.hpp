...
public:
	 ...
	 * Direction of motion represented as a unit vector.
	 */
	xt::xtensor_fixed<double, xt::xshape<3>> get_obs() const;

	/**
	 * Direction of motion represented as a unit vector.
	 */
	void set_obs(xt::xtensor_fixed<double, xt::xshape<3>>);
	 ...
	 */
	xt::xtensor_fixed<double, xt::xshape<3>> get_error_vector() const;

	/**
	 * Error is expressed as rotation uncertainty about two axes, error_vector and and a second
	 * error vector that is orthogonal to both the obs vector and the error_vector.
	 */
	void set_error_vector(xt::xtensor_fixed<double, xt::xshape<3>>);
