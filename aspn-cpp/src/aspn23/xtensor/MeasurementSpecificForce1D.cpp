...
xt::xtensor<double, 1> MeasurementSpecificForce1D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementSpecificForce1D::set_error_model_params(xt::xtensor<double, 1> error_model_params) {
	nullptr_check();
