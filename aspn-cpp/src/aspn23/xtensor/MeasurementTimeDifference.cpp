...
xt::xtensor<double, 1> MeasurementTimeDifference::get_error_model_params() const {
	nullptr_check();
...
void MeasurementTimeDifference::set_error_model_params(xt::xtensor<double, 1> error_model_params) {
	nullptr_check();
