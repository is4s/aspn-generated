...
xt::xtensor_fixed<double, xt::xshape<2>> MeasurementAttitude2D::get_attitude2d() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_attitude2d(xt::xtensor_fixed<double, xt::xshape<2>> attitude2d) {
	nullptr_check();
	memcpy(c_struct->attitude2d, attitude2d.data(), 2 * sizeof(double));
}

xt::xtensor_fixed<double, xt::xshape<2, 2>> MeasurementAttitude2D::get_covariance() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_covariance(xt::xtensor_fixed<double, xt::xshape<2, 2>> covariance) {
	nullptr_check();
...
xt::xtensor<double, 1> MeasurementAttitude2D::get_error_model_params() const {
	nullptr_check();
...
void MeasurementAttitude2D::set_error_model_params(xt::xtensor<double, 1> error_model_params) {
	nullptr_check();
