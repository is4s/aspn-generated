...
public:
	...
	TypeMounting(std::vector<double> lever_arm,
	             std::vector<double> lever_arm_sigma,
	             std::vector<double> orientation_quaternion,
	             std::vector<double> orientation_tilt_error_covariance);
	 ...
	 */
	std::vector<double> get_lever_arm() const;

	/**
	 * 3x1 lever arm vector describing the sensor position in the platform body frame.
	 */
	void set_lever_arm(std::vector<double>);

	/**
	 * 3x1 lever arm uncertainty vector as standard deviations in the platform body frame.
	 */
	std::vector<double> get_lever_arm_sigma() const;

	/**
	 * 3x1 lever arm uncertainty vector as standard deviations in the platform body frame.
	 */
	void set_lever_arm_sigma(std::vector<double>);
