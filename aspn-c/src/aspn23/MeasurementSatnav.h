...
typedef struct Aspn23MeasurementSatnav {
...
Aspn23MeasurementSatnav* ASPN_NULLABLE aspn23_measurement_satnav_copy(Aspn23MeasurementSatnav*);

/**
 * free() all memory held by the given Aspn23MeasurementSatnav,
 * including the struct itself.
 *
 * Pointer fields (obs, integrity) will be freed using
