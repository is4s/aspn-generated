...
enum Aspn23MeasurementRangeToPointErrorModel {
...
typedef struct Aspn23MeasurementRangeToPoint {
	...
	enum Aspn23MeasurementRangeToPointErrorModel error_model;
...
} Aspn23MeasurementRangeToPoint;

Aspn23MeasurementRangeToPoint* ASPN_NULLABLE
aspn23_measurement_range_to_point_new(Aspn23TypeHeader* header,
                                      Aspn23TypeTimestamp* time_of_validity,
                                      Aspn23TypeRemotePoint* remote_point,
                                      double obs,
                                      double variance,
...
Aspn23MeasurementRangeToPoint* ASPN_NULLABLE
aspn23_measurement_range_to_point_copy(Aspn23MeasurementRangeToPoint*);

/**
 * free() all memory held by the given Aspn23MeasurementRangeToPoint,
