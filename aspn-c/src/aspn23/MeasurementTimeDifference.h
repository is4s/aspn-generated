...
enum Aspn23MeasurementTimeDifferenceErrorModel {
...
typedef struct Aspn23MeasurementTimeDifference {
	...
	enum Aspn23MeasurementTimeDifferenceErrorModel error_model;
...
} Aspn23MeasurementTimeDifference;

Aspn23MeasurementTimeDifference* ASPN_NULLABLE
aspn23_measurement_time_difference_new(Aspn23TypeHeader* header,
                                       Aspn23TypeTimestamp* time_of_validity,
                                       int32_t time_of_validity_attosec,
                                       uint8_t clock_id1,
                                       uint8_t clock_id2,
...
Aspn23MeasurementTimeDifference* ASPN_NULLABLE
aspn23_measurement_time_difference_copy(Aspn23MeasurementTimeDifference*);

/**
 * free() all memory held by the given Aspn23MeasurementTimeDifference,
...
void aspn23_measurement_time_difference_free(void* pointer);
void aspn23_measurement_time_difference_free_members(Aspn23MeasurementTimeDifference* self);
