...
class type_satnav_satellite_system(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">bb", self.icd_type_satnav_satellite_system, self.satellite_system))
    ...
    def _decode_one(buf):
        ...
        self.icd_type_satnav_satellite_system, self.satellite_system = struct.unpack(">bb", buf.read(2))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if type_satnav_satellite_system in parents: return 0
    ...
    def _get_packed_fingerprint():
        if type_satnav_satellite_system._packed_fingerprint is None:
            type_satnav_satellite_system._packed_fingerprint = struct.pack(">Q", type_satnav_satellite_system._get_hash_recursive([]))
        return type_satnav_satellite_system._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", type_satnav_satellite_system._get_packed_fingerprint())[0]
