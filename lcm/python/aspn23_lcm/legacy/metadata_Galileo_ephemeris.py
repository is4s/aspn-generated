...
class metadata_Galileo_ephemeris(object):
    ...
    __slots__ = ["icd_metadata_Galileo_ephemeris", "info", "time_of_validity", "nav_msg_type", "prn", "clock", "orbit", "bgd"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "int8_t", "int32_t", "aspn23_lcm.type_satnav_clock", "aspn23_lcm.type_kepler_orbit", "double"]
    ...
    def _get_hash_recursive(parents):
        if metadata_Galileo_ephemeris in parents: return 0
        newparents = parents + [metadata_Galileo_ephemeris]
        tmphash = (0xa77f3330a3eb01f1+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_satnav_clock._get_hash_recursive(newparents)+ aspn23_lcm.type_kepler_orbit._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_Galileo_ephemeris._packed_fingerprint is None:
            metadata_Galileo_ephemeris._packed_fingerprint = struct.pack(">Q", metadata_Galileo_ephemeris._get_hash_recursive([]))
        return metadata_Galileo_ephemeris._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", metadata_Galileo_ephemeris._get_packed_fingerprint())[0]
