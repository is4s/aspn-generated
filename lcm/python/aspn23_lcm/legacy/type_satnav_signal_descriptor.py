...
class type_satnav_signal_descriptor(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">bb", self.icd_type_satnav_signal_descriptor, self.signal_descriptor))
    ...
    def _decode_one(buf):
        ...
        self.icd_type_satnav_signal_descriptor, self.signal_descriptor = struct.unpack(">bb", buf.read(2))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if type_satnav_signal_descriptor in parents: return 0
        tmphash = (0x47a42b3314111276) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if type_satnav_signal_descriptor._packed_fingerprint is None:
            type_satnav_signal_descriptor._packed_fingerprint = struct.pack(">Q", type_satnav_signal_descriptor._get_hash_recursive([]))
        return type_satnav_signal_descriptor._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", type_satnav_signal_descriptor._get_packed_fingerprint())[0]
