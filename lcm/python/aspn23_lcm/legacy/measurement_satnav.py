...
class measurement_satnav(object):
    ...
    __slots__ = ["icd_measurement_satnav", "header", "time_of_validity", "receiver_clock_time", "num_signal_types", "num_signals_tracked", "obs", "num_integrity", "integrity"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_header", "aspn23_lcm.type_timestamp", "aspn23_lcm.type_satnav_time", "int32_t", "int32_t", "aspn23_lcm.type_satnav_obs", "int16_t", "aspn23_lcm.type_integrity"]

    __dimensions__ = [None, None, None, None, None, None, ["num_signals_tracked"], None, ["num_integrity"]]
    ...
    def _get_hash_recursive(parents):
        if measurement_satnav in parents: return 0
        newparents = parents + [measurement_satnav]
        tmphash = (0xabcf36aba23e0faf+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_satnav_time._get_hash_recursive(newparents)+ aspn23_lcm.type_satnav_obs._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_satnav._packed_fingerprint is None:
            measurement_satnav._packed_fingerprint = struct.pack(">Q", measurement_satnav._get_hash_recursive([]))
