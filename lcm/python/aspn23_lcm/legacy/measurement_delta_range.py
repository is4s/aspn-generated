...
class measurement_delta_range(object):
    ...
    __slots__ = ["icd_measurement_delta_range", "header", "time_of_validity", "delta_t", "obs", "variance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def _get_hash_recursive(parents):
        if measurement_delta_range in parents: return 0
        newparents = parents + [measurement_delta_range]
        tmphash = (0x9521ad62b78050bd+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_delta_range._packed_fingerprint is None:
            measurement_delta_range._packed_fingerprint = struct.pack(">Q", measurement_delta_range._get_hash_recursive([]))
