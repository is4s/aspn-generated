...
class measurement_heading(object):
    ...
    __slots__ = ["icd_measurement_heading", "header", "time_of_validity", "reference", "obs", "variance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def _get_hash_recursive(parents):
        if measurement_heading in parents: return 0
        newparents = parents + [measurement_heading]
        tmphash = (0xf518028c3b85f11+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_heading._packed_fingerprint is None:
            measurement_heading._packed_fingerprint = struct.pack(">Q", measurement_heading._get_hash_recursive([]))
