...
class type_satnav_sv_data(object):
    ...
    __slots__ = ["icd_type_satnav_sv_data", "prn", "satellite_system", "ephemeris_type", "sv_data_time", "coordinate_frame", "sv_pos", "sv_vel", "sv_clock_bias", "sv_clock_drift", "group_delay_enum", "group_delay_vector"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">ddb", self.sv_clock_bias, self.sv_clock_drift, self.group_delay_enum))
    ...
    def _decode_one(buf):
        ...
        self.sv_clock_bias, self.sv_clock_drift, self.group_delay_enum = struct.unpack(">ddb", buf.read(17))
        self.group_delay_vector = struct.unpack('>4f', buf.read(16))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if type_satnav_sv_data in parents: return 0
        newparents = parents + [type_satnav_sv_data]
        tmphash = (0x6e0a9f4ab23eba20+ aspn23_lcm.type_satnav_satellite_system._get_hash_recursive(newparents)+ aspn23_lcm.type_satnav_time._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if type_satnav_sv_data._packed_fingerprint is None:
            type_satnav_sv_data._packed_fingerprint = struct.pack(">Q", type_satnav_sv_data._get_hash_recursive([]))
