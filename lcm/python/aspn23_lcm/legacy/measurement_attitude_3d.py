...
class measurement_attitude_3d(object):
    ...
    __slots__ = ["icd_measurement_attitude_3d", "header", "time_of_validity", "reference_frame", "quaternion", "tilt_error_covariance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    __dimensions__ = [None, None, None, None, [4], [3, 3], None, None, ["num_error_model_params"], None, ["num_integrity"]]
    ...
    def _get_hash_recursive(parents):
        if measurement_attitude_3d in parents: return 0
        newparents = parents + [measurement_attitude_3d]
        tmphash = (0x2ad08882568b8806+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_attitude_3d._packed_fingerprint is None:
            measurement_attitude_3d._packed_fingerprint = struct.pack(">Q", measurement_attitude_3d._get_hash_recursive([]))
