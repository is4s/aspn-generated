...
class measurement_frequency_difference(object):
    ...
    __slots__ = ["icd_measurement_frequency_difference", "header", "time_of_validity", "time_of_validity_attosec", "clock_id1", "clock_id2", "freq_diff", "variance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_header", "aspn23_lcm.type_timestamp", "int32_t", "int16_t", "int16_t", "double", "double", "int8_t", "int32_t", "double", "int16_t", "aspn23_lcm.type_integrity"]

    __dimensions__ = [None, None, None, None, None, None, None, None, None, None, ["num_error_model_params"], None, ["num_integrity"]]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">ihhddbi", self.time_of_validity_attosec, self.clock_id1, self.clock_id2, self.freq_diff, self.variance, self.error_model, self.num_error_model_params))
    ...
    def _decode_one(buf):
        ...
        self.time_of_validity_attosec, self.clock_id1, self.clock_id2, self.freq_diff, self.variance, self.error_model, self.num_error_model_params = struct.unpack(">ihhddbi", buf.read(29))
    ...
    def _get_hash_recursive(parents):
        if measurement_frequency_difference in parents: return 0
        newparents = parents + [measurement_frequency_difference]
        tmphash = (0x760e09a792d443b1+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_frequency_difference._packed_fingerprint is None:
            measurement_frequency_difference._packed_fingerprint = struct.pack(">Q", measurement_frequency_difference._get_hash_recursive([]))
        return measurement_frequency_difference._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_frequency_difference._get_packed_fingerprint())[0]
