...
class metadata_satnav_obs(object):
    ...
    __slots__ = ["icd_metadata_satnav_obs", "info", "time_of_validity", "deltarange_interval_start", "deltarange_interval_stop"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "float", "float"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">ff", self.deltarange_interval_start, self.deltarange_interval_stop))
    ...
    def _decode_one(buf):
        ...
        self.deltarange_interval_start, self.deltarange_interval_stop = struct.unpack(">ff", buf.read(8))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if metadata_satnav_obs in parents: return 0
        newparents = parents + [metadata_satnav_obs]
        tmphash = (0xb3625b79e0aa8294+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_satnav_obs._packed_fingerprint is None:
            metadata_satnav_obs._packed_fingerprint = struct.pack(">Q", metadata_satnav_obs._get_hash_recursive([]))
