...
class metadata_generic(object):
    ...
    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "aspn23_lcm.type_mounting"]
    ...
    def _get_hash_recursive(parents):
        if metadata_generic in parents: return 0
        newparents = parents + [metadata_generic]
        tmphash = (0x7080e9865f6baf78+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_mounting._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_generic._packed_fingerprint is None:
            metadata_generic._packed_fingerprint = struct.pack(">Q", metadata_generic._get_hash_recursive([]))
