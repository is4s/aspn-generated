...
class type_direction_2d_to_point(object):
    ...
    __slots__ = ["icd_type_direction_2d_to_point", "remote_point", "reference", "obs", "variance", "has_observation_characteristics", "observation_characteristics", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">bddb", self.reference, self.obs, self.variance, self.has_observation_characteristics))
    ...
    def _get_hash_recursive(parents):
        if type_direction_2d_to_point in parents: return 0
        newparents = parents + [type_direction_2d_to_point]
        tmphash = (0x802c92d942a22e45+ aspn23_lcm.type_remote_point._get_hash_recursive(newparents)+ aspn23_lcm.type_image_feature._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if type_direction_2d_to_point._packed_fingerprint is None:
            type_direction_2d_to_point._packed_fingerprint = struct.pack(">Q", type_direction_2d_to_point._get_hash_recursive([]))
        return type_direction_2d_to_point._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", type_direction_2d_to_point._get_packed_fingerprint())[0]
