...
class metadata_GPS_iono_utc_parameters(object):
    ...
    __slots__ = ["icd_metadata_GPS_iono_utc_parameters", "info", "time_of_validity", "a_0", "a_1", "delta_t_ls", "tot", "wn_t", "wn_lsf", "dn", "delta_t_lsf", "alpha_0", "alpha_1", "alpha_2", "alpha_3", "beta_0", "beta_1", "beta_2", "beta_3"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "double", "double", "int8_t", "int64_t", "int16_t", "int16_t", "int16_t", "int8_t", "double", "double", "double", "double", "double", "double", "double", "double"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">ddbqhhhbdddddddd", self.a_0, self.a_1, self.delta_t_ls, self.tot, self.wn_t, self.wn_lsf, self.dn, self.delta_t_lsf, self.alpha_0, self.alpha_1, self.alpha_2, self.alpha_3, self.beta_0, self.beta_1, self.beta_2, self.beta_3))
    ...
    def _decode_one(buf):
        ...
        self.a_0, self.a_1, self.delta_t_ls, self.tot, self.wn_t, self.wn_lsf, self.dn, self.delta_t_lsf, self.alpha_0, self.alpha_1, self.alpha_2, self.alpha_3, self.beta_0, self.beta_1, self.beta_2, self.beta_3 = struct.unpack(">ddbqhhhbdddddddd", buf.read(96))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if metadata_GPS_iono_utc_parameters in parents: return 0
        newparents = parents + [metadata_GPS_iono_utc_parameters]
        tmphash = (0x14d16d1cc53d43dc+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_GPS_iono_utc_parameters._packed_fingerprint is None:
            metadata_GPS_iono_utc_parameters._packed_fingerprint = struct.pack(">Q", metadata_GPS_iono_utc_parameters._get_hash_recursive([]))
        return metadata_GPS_iono_utc_parameters._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", metadata_GPS_iono_utc_parameters._get_packed_fingerprint())[0]
