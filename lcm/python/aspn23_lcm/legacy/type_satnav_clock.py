...
class type_satnav_clock(object):
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">bdddd", self.icd_type_satnav_clock, self.t_oc, self.af_0, self.af_1, self.af_2))
    ...
    def _decode_one(buf):
        ...
        self.icd_type_satnav_clock, self.t_oc, self.af_0, self.af_1, self.af_2 = struct.unpack(">bdddd", buf.read(33))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if type_satnav_clock in parents: return 0
    ...
    def _get_packed_fingerprint():
        if type_satnav_clock._packed_fingerprint is None:
            type_satnav_clock._packed_fingerprint = struct.pack(">Q", type_satnav_clock._get_hash_recursive([]))
