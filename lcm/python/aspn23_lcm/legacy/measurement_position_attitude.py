...
class measurement_position_attitude(object):
    ...
    __slots__ = ["icd_measurement_position_attitude", "header", "time_of_validity", "reference_frame", "p1", "p2", "p3", "quaternion", "covariance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_header", "aspn23_lcm.type_timestamp", "int8_t", "double", "double", "double", "double", "double", "int8_t", "int32_t", "double", "int16_t", "aspn23_lcm.type_integrity"]

    __dimensions__ = [None, None, None, None, None, None, None, [4], [6, 6], None, None, ["num_error_model_params"], None, ["num_integrity"]]
    ...
    def _decode_one(buf):
        ...
        self.reference_frame, self.p1, self.p2, self.p3 = struct.unpack(">bddd", buf.read(25))
    ...
    def _get_hash_recursive(parents):
        if measurement_position_attitude in parents: return 0
        newparents = parents + [measurement_position_attitude]
        tmphash = (0x20659a8eff6a2801+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_position_attitude._packed_fingerprint is None:
            measurement_position_attitude._packed_fingerprint = struct.pack(">Q", measurement_position_attitude._get_hash_recursive([]))
        return measurement_position_attitude._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_position_attitude._get_packed_fingerprint())[0]
