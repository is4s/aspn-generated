...
class measurement_direction_3d_to_points(object):
    ...
    __slots__ = ["icd_measurement_direction_3d_to_points", "header", "time_of_validity", "num_obs", "obs"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_header", "aspn23_lcm.type_timestamp", "int32_t", "aspn23_lcm.type_direction_3d_to_point"]
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.num_obs):
            assert self.obs[i0]._get_packed_fingerprint() == aspn23_lcm.type_direction_3d_to_point._get_packed_fingerprint()
    ...
    def _decode_one(buf):
        ...
        self.icd_measurement_direction_3d_to_points = struct.unpack(">b", buf.read(1))[0]
    ...
    def _get_hash_recursive(parents):
        if measurement_direction_3d_to_points in parents: return 0
        newparents = parents + [measurement_direction_3d_to_points]
        tmphash = (0x3457c11bdfa63587+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_direction_3d_to_point._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_direction_3d_to_points._packed_fingerprint is None:
            measurement_direction_3d_to_points._packed_fingerprint = struct.pack(">Q", measurement_direction_3d_to_points._get_hash_recursive([]))
        return measurement_direction_3d_to_points._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_direction_3d_to_points._get_packed_fingerprint())[0]
