...
class measurement_specific_force_1d(object):
    ...
    __slots__ = ["icd_measurement_specific_force_1d", "header", "time_of_validity", "sensor_type", "obs", "variance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def _get_hash_recursive(parents):
        if measurement_specific_force_1d in parents: return 0
        newparents = parents + [measurement_specific_force_1d]
        tmphash = (0xbbdfce6767d9127f+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_specific_force_1d._packed_fingerprint is None:
            measurement_specific_force_1d._packed_fingerprint = struct.pack(">Q", measurement_specific_force_1d._get_hash_recursive([]))
        return measurement_specific_force_1d._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_specific_force_1d._get_packed_fingerprint())[0]
