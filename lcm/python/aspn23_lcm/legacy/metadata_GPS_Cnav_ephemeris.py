...
class metadata_GPS_Cnav_ephemeris(object):
    ...
    __slots__ = ["icd_metadata_GPS_Cnav_ephemeris", "info", "time_of_validity", "week_number", "prn", "clock", "orbit", "t_gd", "iodc", "iode", "isc_l1_ca", "isc_l2_c", "isc_l5_i5", "isc_l5_q5", "delta_a_0", "a_dot"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "int32_t", "int32_t", "aspn23_lcm.type_satnav_clock", "aspn23_lcm.type_kepler_orbit", "double", "int32_t", "int16_t", "double", "double", "double", "double", "double", "double"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">dihdddddd", self.t_gd, self.iodc, self.iode, self.isc_l1_ca, self.isc_l2_c, self.isc_l5_i5, self.isc_l5_q5, self.delta_a_0, self.a_dot))
    ...
    def _decode_one(buf):
        ...
        self.t_gd, self.iodc, self.iode, self.isc_l1_ca, self.isc_l2_c, self.isc_l5_i5, self.isc_l5_q5, self.delta_a_0, self.a_dot = struct.unpack(">dihdddddd", buf.read(62))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if metadata_GPS_Cnav_ephemeris in parents: return 0
        newparents = parents + [metadata_GPS_Cnav_ephemeris]
        tmphash = (0x7a5562342022ba83+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_satnav_clock._get_hash_recursive(newparents)+ aspn23_lcm.type_kepler_orbit._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_GPS_Cnav_ephemeris._packed_fingerprint is None:
            metadata_GPS_Cnav_ephemeris._packed_fingerprint = struct.pack(">Q", metadata_GPS_Cnav_ephemeris._get_hash_recursive([]))
        return metadata_GPS_Cnav_ephemeris._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", metadata_GPS_Cnav_ephemeris._get_packed_fingerprint())[0]
