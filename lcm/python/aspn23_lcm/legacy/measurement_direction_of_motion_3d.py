...
class measurement_direction_of_motion_3d(object):
    ...
    __slots__ = ["icd_measurement_direction_of_motion_3d", "header", "time_of_validity", "reference_frame", "obs", "error_vector", "covariance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_header", "aspn23_lcm.type_timestamp", "int8_t", "double", "double", "double", "int8_t", "int32_t", "double", "int16_t", "aspn23_lcm.type_integrity"]

    __dimensions__ = [None, None, None, None, [3], [3], [2, 2], None, None, ["num_error_model_params"], None, ["num_integrity"]]
    ...
    def _decode_one(buf):
        ...
        self.icd_measurement_direction_of_motion_3d = struct.unpack(">b", buf.read(1))[0]
    ...
    def _get_hash_recursive(parents):
        if measurement_direction_of_motion_3d in parents: return 0
        newparents = parents + [measurement_direction_of_motion_3d]
        tmphash = (0xef0ce4edb7929076+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_direction_of_motion_3d._packed_fingerprint is None:
            measurement_direction_of_motion_3d._packed_fingerprint = struct.pack(">Q", measurement_direction_of_motion_3d._get_hash_recursive([]))
        return measurement_direction_of_motion_3d._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_direction_of_motion_3d._get_packed_fingerprint())[0]
