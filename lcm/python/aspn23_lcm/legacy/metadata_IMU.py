...
class metadata_IMU(object):
    ...
    __slots__ = ["icd_metadata_IMU", "info", "time_of_validity", "mounting", "error_model", "num_error_model_params", "error_model_params"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "aspn23_lcm.type_mounting", "int8_t", "int32_t", "double"]
    ...
    def _get_hash_recursive(parents):
        if metadata_IMU in parents: return 0
        newparents = parents + [metadata_IMU]
        tmphash = (0x122614f90ce6e8f8+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_mounting._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_IMU._packed_fingerprint is None:
            metadata_IMU._packed_fingerprint = struct.pack(">Q", metadata_IMU._get_hash_recursive([]))
