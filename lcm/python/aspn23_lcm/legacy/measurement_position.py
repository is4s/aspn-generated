...
class measurement_position(object):
    ...
    __slots__ = ["icd_measurement_position", "header", "time_of_validity", "reference_frame", "term1", "term2", "term3", "num_meas", "covariance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">bdddh", self.reference_frame, self.term1, self.term2, self.term3, self.num_meas))
    ...
    def _decode_one(buf):
        ...
        self.reference_frame, self.term1, self.term2, self.term3, self.num_meas = struct.unpack(">bdddh", buf.read(27))
        self.covariance = []
        for i0 in range(self.num_meas):
    ...
    def _get_hash_recursive(parents):
        if measurement_position in parents: return 0
        newparents = parents + [measurement_position]
        tmphash = (0xf8c23b6aecb77b7a+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_position._packed_fingerprint is None:
            measurement_position._packed_fingerprint = struct.pack(">Q", measurement_position._get_hash_recursive([]))
