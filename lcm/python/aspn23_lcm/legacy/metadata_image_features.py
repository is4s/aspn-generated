...
class metadata_image_features(object):
    ...
    __slots__ = ["icd_metadata_image_features", "info", "time_of_validity", "keypoint_detector", "orientation_calculated", "descriptor_extractor", "is_bigendian", "descriptor_type", "descriptor_number_of_elements"]

    __typenames__ = ["int8_t", "aspn23_lcm.type_metadataheader", "aspn23_lcm.type_timestamp", "int8_t", "boolean", "int8_t", "boolean", "int8_t", "int32_t"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack(">bbbbbi", self.keypoint_detector, self.orientation_calculated, self.descriptor_extractor, self.is_bigendian, self.descriptor_type, self.descriptor_number_of_elements))
    ...
    def _decode_one(buf):
        ...
        self.descriptor_type, self.descriptor_number_of_elements = struct.unpack(">bi", buf.read(5))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if metadata_image_features in parents: return 0
        newparents = parents + [metadata_image_features]
        tmphash = (0xec486cdd2ed94097+ aspn23_lcm.type_metadataheader._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if metadata_image_features._packed_fingerprint is None:
            metadata_image_features._packed_fingerprint = struct.pack(">Q", metadata_image_features._get_hash_recursive([]))
