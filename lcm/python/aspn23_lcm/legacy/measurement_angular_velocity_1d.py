...
class measurement_angular_velocity_1d(object):
    """
    Measures the angular velocity about the sense-axis. The sense-axis is the sensor frame x-axis as
    defined in mounting.
    """

    __slots__ = ["icd_measurement_angular_velocity_1d", "header", "time_of_validity", "sensor_type", "obs", "variance", "error_model", "num_error_model_params", "error_model_params", "num_integrity", "integrity"]
    ...
    def __init__(self):
        self.icd_measurement_angular_velocity_1d = 0
        """
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(measurement_angular_velocity_1d._get_packed_fingerprint())
        self._encode_one(buf)
        return buf.getvalue()

    def _encode_one(self, buf):
        buf.write(struct.pack(">b", self.icd_measurement_angular_velocity_1d))
        ...
        buf.write(struct.pack(">bddbi", self.sensor_type, self.obs, self.variance, self.error_model, self.num_error_model_params))
    ...
    def decode(data: bytes):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != measurement_angular_velocity_1d._get_packed_fingerprint():
            raise ValueError("Decode error")
        return measurement_angular_velocity_1d._decode_one(buf)

    @staticmethod
    def _decode_one(buf):
        self = measurement_angular_velocity_1d()
        self.icd_measurement_angular_velocity_1d = struct.unpack(">b", buf.read(1))[0]
        self.header = aspn23_lcm.type_header._decode_one(buf)
        self.time_of_validity = aspn23_lcm.type_timestamp._decode_one(buf)
        self.sensor_type, self.obs, self.variance, self.error_model, self.num_error_model_params = struct.unpack(">bddbi", buf.read(22))
    ...
    def _get_hash_recursive(parents):
        if measurement_angular_velocity_1d in parents: return 0
        newparents = parents + [measurement_angular_velocity_1d]
        tmphash = (0x12f07ba25438014e+ aspn23_lcm.type_header._get_hash_recursive(newparents)+ aspn23_lcm.type_timestamp._get_hash_recursive(newparents)+ aspn23_lcm.type_integrity._get_hash_recursive(newparents)) & 0xffffffffffffffff
    ...
    def _get_packed_fingerprint():
        if measurement_angular_velocity_1d._packed_fingerprint is None:
            measurement_angular_velocity_1d._packed_fingerprint = struct.pack(">Q", measurement_angular_velocity_1d._get_hash_recursive([]))
        return measurement_angular_velocity_1d._packed_fingerprint

    def get_hash(self):
        """Get the LCM hash of the struct"""
        return struct.unpack(">Q", measurement_angular_velocity_1d._get_packed_fingerprint())[0]
