...
to_lcm_map: dict[type[AspnMsg], Callable] = {
    ...
    MeasurementImage: measurement_image_to_lcm,
...
from_lcm_map: dict[type[LcmMsg], Callable] = {
    ...
    LcmMeasurementImage: lcm_to_measurement_image,
...
decode_lcm_map: dict[bytes, Callable] = {
    ...
    LcmMeasurementImage._get_packed_fingerprint(): LcmMeasurementImage.decode,
